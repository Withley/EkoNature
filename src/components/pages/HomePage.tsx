  ...
  return (
    <div className="min-h-[calc(100vh-64px)] md:min-h-[calc(100vh-72px)]">
      ...
      <section className="relative max-w-[1440px] mx-auto px-4 md:px-8 lg:px-[120px] py-12 md:py-20 lg:py-32">
        ...
        >
          <motion.h1 
            className={`mb-4 md:mb-6 px-4 ${isDarkMode ? 'text-[#E1E1E1]' : 'text-gray-900'}`}
          ...
          <motion.p 
            className={`text-base md:text-lg lg:text-xl mb-8 md:mb-12 px-4 ${isDarkMode ? 'text-[#E1E1E1] opacity-80' : 'text-gray-700'}`}
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <section className={`py-12 md:py-16 ${isDarkMode ? 'bg-[#1A2324]' : 'bg-gray-50'}`}>
        <div className="max-w-[1440px] mx-auto px-4 md:px-8 lg:px-[120px]">
          <motion.h2 
            className={`text-center mb-8 md:mb-12 ${isDarkMode ? 'text-[#E1E1E1]' : 'text-gray-900'}`}
            initial={{ opacity: 0, y: 20 }}
      ...
      <section className="max-w-[1440px] mx-auto px-4 md:px-8 lg:px-[120px] py-12 md:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className={`mb-4 md:mb-6 ${isDarkMode ? 'text-[#E1E1E1]' : 'text-gray-900'}`}>{t('ourMission')}</h2>
            <p className={`mb-4 md:mb-6 ${isDarkMode ? 'text-[#E1E1E1] opacity-80' : 'text-gray-700'}`}>
              {t('ourMissionText')}
            </p>
            <ul className={`space-y-3 ${isDarkMode ? 'text-[#E1E1E1] opacity-80' : 'text-gray-700'}`}>
              <motion.li 
          ...
          <motion.div 
            className={`rounded-[16px] p-6 md:p-8 text-center ${isDarkMode ? 'bg-[#1A2324]' : 'bg-white border border-gray-200'}`}
            style={{ boxShadow: '0 4px 24px rgba(0,0,0,0.35)' }}
            initial={{ opacity: 0, x: 30 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            whileHover={{ y: -5, boxShadow: '0 8px 32px rgba(0,197,122,0.2)' }}
          >
            <motion.div 
            ...
            <h3 className={`mb-3 md:mb-4 ${isDarkMode ? 'text-[#E1E1E1]' : 'text-gray-900'}`}>{t('community')}</h3>
            <p className={`caption mb-4 md:mb-6 ${isDarkMode ? 'text-[#E1E1E1] opacity-70' : 'text-gray-600'}`}>
              {t('communityText')}
            </p>
            <motion.button
